...
class List {
  ...
  private:
    ...
    // flipper function for thee reverse 
    void Penguin( ListNode *&curr,  ListNode *& endPoint);
    /**
    ...
    void pointerMergeNext(ListNode*& first, ListNode*& second);
    void pointerMergePrev(ListNode *& first, ListNode *&inserted);
